...
/* =========================================================
   RELUZ PRODUÇÃO
   FIREBASE - CONFIGURAÇÃO OFICIAL DO PROJETO
   ========================================================= */
...
auth.onAuthStateChanged(async user => {
    ...
    try {
        ...
        if (!snap.exists) {
            ...
            throw new Error(
                "Usuário autenticado, porém sem perfil cadastrado no Firestore."
            );
        }
                            ...
                            rows.length
                                ? rows.map(r => `
                                    <tr>
                                        ...
                                        <td>${kg(r.weight)}</td>
                                        <td>${escapeHtml([...r.clients].join(", "))}</td>
                                        <td>${r.lots}</td>
                                    </tr>
                                `).join("")
                                : `
    ...
    $("userForm").addEventListener(
        ...
        async e => {
            ...
            try {
                ...
                /*
                 * Cria um segundo app Firebase
                 * para cadastrar o colaborador
